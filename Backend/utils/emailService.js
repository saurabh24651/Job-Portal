...
export const sendVerificationEmail=async(
    ...
    return sendEmail({
        to:[{email, name}],
        subject:"Your Verfication Code - JobPortal",
...
export const sendForgetPasswordEmail=async(
    ...
    return sendEmail({
        ...
        htmlContent: otpTemplate("Verify Your Email", name,otp,
            "You requested to reset your password. Please use the following 6-digit code to verify your email address"
        )
    });
}

//to send admin inquiry
export const sendAdminInquiryEmail=async(
    data
)=>{
    const htmlContent = `
